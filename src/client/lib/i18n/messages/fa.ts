...
export const fa: Partial<Messages> = {
  ...
  'hero.configBelowNote':
    'پیکربندی کامل شما در پایین است — سرورها را به‌صورت دستی اضافه کنید. برای حفظ حریم خصوصی، لینک اشتراکِ خودبه‌روزرسان اینجا نشان داده نمی‌شود (برنامهٔ شما آن را از طریق یک CDN دریافت می‌کند).',
