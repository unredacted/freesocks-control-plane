...
export const fa: Partial<Messages> = {
  ...
  'delivery.heroPrivacyNote':
    'توجه: برنامهٔ شما این لینک را از طریق یک CDN دریافت می‌کند که می‌تواند پیکربندی شما را ببیند. برای حداکثر حریم خصوصی، سرورها را به‌صورت دستی از پیکربندی خام زیر اضافه کنید.',
};
