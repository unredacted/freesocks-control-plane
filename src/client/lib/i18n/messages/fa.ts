...
export const fa: Partial<Messages> = {
  ...
  'get.introReady': 'حساب و اشتراک شما آماده‌اند.',
  'get.introReadyNoSub': 'حساب شما آماده است. برای دریافت کلید، در پایین یک اشتراک بسازید.',
  ...
  'get.accountReadyTier': (p) => `حساب شما در سطح ${p.tier} آماده است.`,
