...
export const ru: Partial<Messages> = {
  ...
  'delivery.heroPrivacyNote':
    'Важно: ваше приложение загружает эту ссылку через CDN, который может видеть ваш конфиг. Для максимальной приватности добавьте серверы вручную из необработанной конфигурации ниже.',
};
