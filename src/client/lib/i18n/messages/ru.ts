...
export const ru: Partial<Messages> = {
  ...
  'get.introReady': 'Ваш аккаунт и подписка готовы.',
  'get.introReadyNoSub': 'Аккаунт готов. Создайте подписку ниже, чтобы получить ключ.',
  ...
  'get.accountReadyTier': (p) => `Ваш аккаунт готов на тарифе ${p.tier}.`,
  ...
  'get.upsellBody':
    'Ваш бесплатный аккаунт готов. В любой момент оформите членство FreeSocks ради безлимитного трафика и устройств.',
};
