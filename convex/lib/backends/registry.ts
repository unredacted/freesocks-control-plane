...
import {
  ...
  remnawaveCreateNode,
  remnawaveUpdateNode,
  remnawaveSetNodeEnabled,
  remnawaveRestartNode,
  remnawaveDeleteNode,
  remnawaveReadHosts,
  remnawavePreviewProfilePatch,
  remnawaveApplyProfilePatch,
...
const remnawaveProvider: BackendProvider<RemnawaveServerConfig> = {
  ...
  panelWrites: {
    ...
    restartNode: remnawaveRestartNode,
    deleteNode: remnawaveDeleteNode,
    previewProfilePatch: remnawavePreviewProfilePatch,
    applyProfilePatch: remnawaveApplyProfilePatch,
    readProfile: remnawaveReadProfile,
