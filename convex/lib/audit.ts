...
export const AUDIT_PAYLOAD_ALLOWLIST: Readonly<Record<string, readonly string[]>> = {
  ...
  'relay.edge.published': ['relaySlug', 'edgeId', 'poolIndex', 'epoch'],
  'relay.edge.unpublished': ['relaySlug', 'edgeId', 'poolIndex', 'epoch'],
  ...
  'relay.burned': ['relaySlug', 'trigger', 'edgeId'],
  'relay.rotated': [
    'relaySlug',
    'trigger',
    'kind',
  ...
  'relay.quarantine_resolved': ['relaySlug', 'keep'],
  ...
  'admin.relay.rotate': ['slug', 'trigger', 'force'],
  'admin.relay.burn': ['slug', 'trigger', 'force'],
  'admin.relay.provision': ['slug', 'trigger'],
  'admin.relay.cancel': ['slug'],
};
