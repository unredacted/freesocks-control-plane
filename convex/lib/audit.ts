...
export const AUDIT_PAYLOAD_ALLOWLIST: Readonly<Record<string, readonly string[]>> = {
  ...
  'relay.provider_account.create': ['name', 'provider'],
  'relay.provider_account.update': ['name', 'provider'],
  'relay.provider_account.delete': ['name', 'provider'],
  'relay.provider_account.upsert': ['name', 'provider', 'created'],
  'relay.provider_account.qualified': ['name', 'provider', 'qualified'],
  'relay.template.create': ['provider', 'name'],
  'relay.template.update': ['provider', 'name'],
  'relay.template.delete': ['provider', 'name'],
  'relay.profile.create': ['slug', 'provider'],
  'relay.profile.update': ['slug', 'provider'],
  'relay.profile.delete': ['slug', 'provider'],
  'relay.profile.qualified': ['slug', 'provider', 'tlsOk', 'authOk'],
  'relay.sni.retire': ['profileSlug', 'count'],
  'relay.sni.reactivate': ['profileSlug', 'count'],
  'relay.create': ['slug'],
  'relay.update': ['slug'],
  'relay.delete': ['slug'],
  'relay.upsert': ['slug', 'created'],
  'relay.edge.adopted': ['slug', 'edgeId', 'managed', 'publication'],
  'relay.slot.upsert': ['relaySlug', 'slotKey', 'created'],
  'relay.slot.retire': ['relaySlug', 'slotKey'],
  'relay.edge.published': ['relaySlug', 'edgeId', 'poolIndex', 'epoch', 'rotationId'],
  'relay.edge.unpublished': ['relaySlug', 'edgeId', 'poolIndex', 'epoch', 'rotationId'],
  'relay.edge.destroyed': ['relaySlug', 'provider', 'edgeId'],
  'relay.edge.destroy_failed': ['relaySlug', 'provider', 'edgeId', 'attempts'],
  'relay.edge.delete': ['relaySlug', 'edgeId', 'force'],
  'relay.burned': ['relaySlug', 'trigger', 'edgeId', 'rotationId'],
  'relay.rotated': [
    'relaySlug',
    'trigger',
    'kind',
  ...
  'relay.rotation_failed': ['relaySlug', 'trigger', 'phase', 'outcome', 'step', 'code'],
  'relay.rolled_back': ['relaySlug', 'hosts'],
  'relay.quarantined': ['relaySlug', 'rotationId', 'reason'],
  'relay.quarantine_resolved': ['relaySlug', 'keep', 'rotationId'],
  'relay.drift': ['relaySlug', 'edgeId', 'mismatched', 'total'],
  'relay.orphan_suspected': ['provider', 'name', 'step'],
  'relay.block_suspected': [
    'relaySlug',
    'hintLevel',
    'score',
    'reporters',
  ...
  'relay.block_cleared': ['relaySlug', 'reason'],
  'relay.probe.run': ['targetKey', 'source', 'trigger'],
  'relay.probe.verdict': ['targetKey', 'source', 'country', 'ipVersion', 'verdict'],
  'relay.probe.requested': ['targets', 'runs', 'sources'],
  'relay.probe.target.create': ['label'],
  'relay.probe.target.update': ['label'],
  'relay.probe.target.delete': ['label'],
  'relay.live.pulled': ['edgeId', 'accountId'],
  'admin.relay.config.change': ['changedKeys'],
  'admin.relay.render.change': ['changedKeys'],
  'admin.relay.probe.change': ['changedKeys'],
  'admin.relay.rotate': ['slug', 'trigger', 'force', 'rotationId'],
  'admin.relay.burn': ['slug', 'trigger', 'force', 'rotationId'],
  'admin.relay.provision': ['slug', 'trigger', 'rotationId'],
  'admin.relay.cancel': ['slug', 'rotationId'],
};
