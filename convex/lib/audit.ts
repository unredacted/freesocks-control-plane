...
export const AUDIT_PAYLOAD_ALLOWLIST: Readonly<Record<string, readonly string[]>> = {
  ...
  'relay.origin.create': ['slug'],
  'relay.origin.update': ['slug'],
  'relay.origin.delete': ['slug'],
  'relay.origin.upsert': ['slug', 'created'],
  'relay.origin.adopt': ['slug', 'edgeId', 'managed', 'publication'],
  'relay.slot.upsert': ['originSlug', 'slotKey', 'created'],
  'relay.slot.retire': ['originSlug', 'slotKey'],
  'relay.edge.published': ['originSlug', 'edgeId', 'poolIndex', 'epoch'],
  'relay.edge.unpublished': ['originSlug', 'edgeId', 'poolIndex', 'epoch'],
  'relay.edge.destroyed': ['originSlug', 'provider', 'edgeId'],
  'relay.edge.destroy_failed': ['originSlug', 'provider', 'edgeId', 'attempts'],
  'relay.edge.delete': ['originSlug', 'edgeId', 'force'],
  'relay.burned': ['originSlug', 'trigger', 'edgeId'],
  'relay.rotated': [
    'originSlug',
    'trigger',
    'kind',
  ...
  'relay.rotation_failed': ['originSlug', 'trigger', 'phase', 'outcome', 'step', 'code'],
  'relay.rolled_back': ['originSlug', 'hosts'],
  'relay.quarantined': ['originSlug', 'rotationId', 'reason'],
  'relay.quarantine_resolved': ['originSlug', 'keep'],
  'relay.drift': ['originSlug', 'edgeId', 'mismatched', 'total'],
  ...
  'relay.block_cleared': ['originSlug', 'reason'],
  'relay.probe.run': ['edgeId', 'source', 'trigger'],
  'relay.probe.verdict': ['edgeId', 'source', 'country', 'verdict'],
  ...
  'admin.relay.origin.rotate': ['slug', 'trigger', 'force'],
  'admin.relay.origin.burn': ['slug', 'trigger', 'force'],
  'admin.relay.origin.provision': ['slug', 'trigger'],
  'admin.relay.origin.cancel': ['slug'],
};
