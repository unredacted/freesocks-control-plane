...
import type { TestLink } from './edgeTestLinks';
...
export interface StageOps {
  ...
  buildTestLink(ctx: ActionCtx, edgeId: Id<'edges'>): Promise<TestLink>;
  hideHosts(
    ctx: ActionCtx,
...
const defaultOps: StageOps = {
  ...
  vectorNow: (ctx, relayId) => ctx.runQuery(internal.edgeRehearsal.vectorNow, { relayId }),
